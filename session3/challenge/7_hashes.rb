...
class HTMLTag
  ...
  def style
    return nil if options[:font] == nil  && options[:color] == nil
    return "style='font-family:#{font};color:#{color};'" if options[:font] && options[:color]
    return "style='font-family:#{font}'" if options[:font]
